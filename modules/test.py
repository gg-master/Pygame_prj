...
class SettingsWindow:
    ...
    def create_background(self):
        ...
        self.background.blit(music_text, (WIDTH * 0.03125 - music_text.get_width() / 2, HEIGHT * 0.32407407))
        self.background.blit(eff_text, (WIDTH * 0.083333 - eff_text.get_width() / 2, HEIGHT * 0.32407407))
        self.background.blit(control_text, (WIDTH * 0.20833 - control_text.get_width() / 2, HEIGHT * 0.125 - int(control_text.get_height() / 2)))
        self.background.blit(player_nick_text, (WIDTH * 0.114583, HEIGHT * 0.0805 - int(player_nick_text.get_height() / 2)))
        self.background.blit(forward_text, (WIDTH * 0.114583, HEIGHT * 0.162037 - int(player_nick_text.get_height() / 2)))
        self.background.blit(back_text, (WIDTH * 0.114583, HEIGHT * 0.2037 - int(player_nick_text.get_height() / 2)))
        self.background.blit(left_text, (WIDTH * 0.114583, HEIGHT * 0.24537 - int(player_nick_text.get_height() / 2)))
        self.background.blit(right_text, (WIDTH * 0.114583, HEIGHT * 0.287037 - int(player_nick_text.get_height() / 2)))
        self.background.blit(shoot_text, (WIDTH * 0.114583, HEIGHT * 0.3287037 - int(player_nick_text.get_height() / 2)))
        self.background.blit(header_text, ((self.width - header_text.get_width()) / 2, self.height * 0.03))
        pg.draw.line(self.background, (57,59,61), (0, self.height * 0.11805), (self.width, self.height * 0.11805), 3)
        pg.draw.rect(self.background, (47, 48, 48), (self.width * 0.015625, self.height * 0.13953488372, self.width * 0.96875, self.height * 0.756944), 2)
        pg.draw.rect(self.background, (57,59,61), (0, 0, self.width, self.height), 6)
        pg.draw.line(self.background, (47, 48, 48), (self.width * 0.171875, round(self.height * 0.13888)), (self.width * 0.171875, self.height * 0.8912037), 2)
        pg.draw.line(self.background, (47, 48, 48), (self.width * 0.328125, round(self.height * 0.13888)), (self.width * 0.328125, self.height * 0.8912037), 2)
        pg.draw.line(self.background, (47, 48, 48), (self.width * 0.328125, self.height * 0.2662037), (self.width * 0.984375, self.height * 0.2662037), 2)

    def draw(self, win):
        self.window_scr.blit(self.background, (0, 0))
        if self.none_button:
            self.window_scr.blit(self.none_button_text1, (self.width * 0.0234375, self.height * 0.90277777))
            self.window_scr.blit(self.none_button_text2, (self.width * 0.0234375, self.height * 0.949074))
        self.window_scr.blit(self.music_bar.draw(), (self.width * 0.078125, self.height * 0.162037))
        self.window_scr.blit(self.effects_bar.draw(), (self.width * 0.234375, self.height * 0.162037))
        win.blit(self.window_scr, ((WIDTH - self.width) / 2, (HEIGHT - self.height) / 1.883720))
    ...
    def update(self):
        ...
        self.line_edits_arr = [InputBox(WIDTH * 0.5052083, HEIGHT * 0.386111, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.first_player_nick, centering=True),
                          InputBox(WIDTH * 0.5833333, HEIGHT * 0.386111, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.second_player_nick, centering=True),
                          InputBox(WIDTH * 0.5052083, HEIGHT * 0.467592, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.forward_btn_1_text, centering=True, usual=False, btn=self.forward_btn_1),
                          InputBox(WIDTH * 0.5833333, HEIGHT * 0.467592, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.forward_btn_2_text, centering=True, usual=False, btn=self.forward_btn_2),
                          InputBox(WIDTH * 0.5052083, HEIGHT * 0.50925925, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.back_btn_1_text, centering=True, usual=False, btn=self.back_btn_1),
                          InputBox(WIDTH * 0.5833333, HEIGHT * 0.50925925, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.back_btn_2_text, centering=True, usual=False, btn=self.back_btn_2),
                          InputBox(WIDTH * 0.5052083, HEIGHT * 0.550925, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.left_btn_1_text, centering=True, usual=False, btn=self.left_btn_1),
                          InputBox(WIDTH * 0.5833333, HEIGHT * 0.550925, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.left_btn_2_text, centering=True, usual=False, btn=self.left_btn_2),
                          InputBox(WIDTH * 0.5052083, HEIGHT * 0.5925925, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.right_btn_1_text, centering=True, usual=False, btn=self.right_btn_1),
                          InputBox(WIDTH * 0.5833333, HEIGHT * 0.5925925, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.right_btn_2_text, centering=True, usual=False, btn=self.right_btn_2),
                          InputBox(WIDTH * 0.5052083, HEIGHT * 0.634259, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.shoot_btn_1_text, centering=True, usual=False, btn=self.shoot_btn_1),
                          InputBox(WIDTH * 0.5833333, HEIGHT * 0.634259, WIDTH * 0.0729166, HEIGHT * 0.0277777, text=self.shoot_btn_2_text, centering=True, usual=False, btn=self.shoot_btn_2)]
...
settings_wnd_btns = [[Button('Сохранить', WIDTH * 0.491666, HEIGHT * 0.682407, width=int(WIDTH * 0.1), height=int(HEIGHT * 0.03), size=round(WIDTH * 0.010416), limit=(20, 0)), setting_window.saving, (False, )],
                     [Button('Назад', WIDTH * 0.5697916, HEIGHT * 0.682407, width=int(WIDTH * 0.1), height=int(HEIGHT * 0.03), size=round(WIDTH * 0.010416), limit=(20, 0)), change_settings_f, (False, )],
